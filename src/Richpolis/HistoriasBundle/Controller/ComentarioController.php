...
class ComentarioController extends Controller
{
     ...
     * @Method("POST")
     * @Template("HistoriasBundle:Comentario:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HistoriasBundle:Comentario')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HistoriasBundle:Comentario:edit.html.twig")
     */
    ...
    public function exportarAction() {
        $comentarios = $this->getDoctrine()
                ->getRepository('HistoriasBundle:Comentario')
                ->findComentarios();
