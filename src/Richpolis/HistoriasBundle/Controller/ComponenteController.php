...
use Richpolis\HistoriasBundle\Form\ComponenteType;
...
class ComponenteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HistoriasBundle:Componente')->findAll();
     ...
     * @Method("POST")
     * @Template("HistoriasBundle:Componente:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HistoriasBundle:Componente')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HistoriasBundle:Componente:edit.html.twig")
     */
